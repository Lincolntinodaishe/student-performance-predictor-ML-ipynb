...
study_time = st.slider("Study Time (hours per day)", 0, 12.0, 2.0)
social_media_time = st.slider("Social Media Time (hours per day)", 0, 12.0, 2.0)
attendance = st.slider("Attendance Rate (%)", 0, 100, 80)
mental_health = st.slider("Mental Health Score (1-10)", 1, 10, 5)
sleep_hours = st.slider("Sleep Hours (per night)", 0, 12.0, 7.0)
